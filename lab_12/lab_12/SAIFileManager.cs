...
первоначальный файл.*/
        ...
        dir.CreateSubdirectory("SAIInspect");

        dir = new(path + "\\SAIInspect");

        string path_dirInfo = "SAIdirinfo.txt";
...
XXXInspect.*/
    ...
    public static void Remove(string path)
    {
        ...
        SAILog.WriteToFile(MethodBase.GetCurrentMethod().Name, MethodBase.GetCurrentMethod().DeclaringType.Name);
    }
